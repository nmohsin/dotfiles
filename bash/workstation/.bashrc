...
# More functionality for g4 completions.
source /google/data/ro/projects/bash/g4_complete.sh

# Make g4 use relative paths.
...
# Boq preprocessing for BUILD files.
export BLAZE_COMPLETION_USE_QUERY=true

# Workaround for b/16150412.
